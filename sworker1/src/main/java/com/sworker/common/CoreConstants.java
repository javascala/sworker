...
public abstract class CoreConstants {
	...
	public static final String LOG_PACKAGE_DEBUG = "fasf_core.debug";

	public static final String LOG_PACKAGE_INFO = "fasf_core.info";

	public static final String LOG_PACKAGE_SQL = "fasf_core.sql";

	public static final String LOG_PACKAGE_PERFORMANCE = "fasf_core.pf";

	public static final String LOG_PACKAGE_WEBSERVICE = "fasf_core.webservice";

	public static final String SETTING_CONTEXT_FILES = "spring.context.files";

    public static final Map<String, String> entityDataSourceMap = new HashMap<String, String>();
}
